...
class TutorOrchestrator:
    ...
    def respond(self, learner_message: str, learning_state: dict[str, Any]) -> TutorResponse:
        ...
        tool_definitions = [{"type": "function", "name": name, "description": f"Executa a ferramenta {name}", "parameters": {"type": "object", "additionalProperties": True}} for name in self.registry.names]
